  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="relative overflow-hidden">
        ...
        <section
          id="about"
          className="scroll-mt-24 mx-auto w-full max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:pb-15 lg:pt-15"
        >
        ...
        <section
          id="services"
          className="scroll-mt-24 mx-auto w-full max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:pb-15 lg:pt-8"
        >
        ...
        <section
          id="process"
          className="scroll-mt-24 mx-auto w-full max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:pb-20 lg:pt-15"
        >
          <div data-reveal className="mx-auto max-w-4xl text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">
              How It Works
        ...
        <section
          id="faq"
          className="scroll-mt-24 mx-auto w-full max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:pb-10 lg:pt-15"
        >
          <div data-reveal className="mx-auto max-w-4xl text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500">
              Q&A
